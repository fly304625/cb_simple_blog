...
class FrontController extends Controller
{
    ...
    public function getCategory($id, $slug){
        ...
        $data['row'] = $row;
        $data['page_title'] = $row->name.' | Category | '.$this->blog_name;
    ...
    public function getLastest(){
        ...
        $data['page_title'] = 'Lastest | '.$this->blog_name;
        $data['page_description'] = $data['page_title'];
        $data['blog_name'] = $this->blog_name;
        $data['categories'] = DB::table('categories')->get();
        $data['header_title'] = "Lastest";
    ...
    public function getSearch(Request $req){
        ...
        $data['page_title'] = 'Search '. $req->get('q') .$this->blog_name;
        $data['page_description'] = $data['page_title'];
        $data['blog_name'] = $this->blog_name;
        $data['categories'] = DB::table('categories')->get();
